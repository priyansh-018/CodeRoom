...
export const handleAdminReply = async (req: Request, res: Response) => {
  try {
...
export const serveAdminReplyPage = async (req: Request, res: Response) => {
  const { to, name, ticket, subject, secret } = req.query as Record<string, string>;
